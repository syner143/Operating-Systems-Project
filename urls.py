...
urlpatterns = [
    ...
    url(r'^appform/', views.appform, name="appform"),
    url(r'^appforminsert/', views.appforminsert, name="appforminsert"),
    url(r'^appformupdate(?P<foo>[0-9]+)/', views.appformupdate, name="appformupdate"),
    url(r'^appformview(?P<foo>[0-9]+)/', views.appformview, name="appformview"),
    url(r'^appformdelete(?P<foo>[0-9]+)/', views.appformdelete, name="appformdelete"),
    url(r'^apptable/', views.apptable, name='apptable'),
]
